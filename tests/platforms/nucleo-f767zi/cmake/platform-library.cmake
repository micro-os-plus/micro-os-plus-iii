...
target_include_directories (
  platform-nucleo-f767zi-interface INTERFACE "include"
)

target_sources (platform-nucleo-f767zi-interface INTERFACE # None
)

target_compile_definitions (
  platform-nucleo-f767zi-interface
...
target_compile_options (
  platform-nucleo-f767zi-interface INTERFACE ${xpack_platform_common_options}
)
...
if ("${CMAKE_C_COMPILER_VERSION}" VERSION_GREATER_EQUAL "12.0.0")
  target_link_options (
    platform-nucleo-f767zi-interface INTERFACE
...
target_link_libraries (
  platform-nucleo-f767zi-interface INTERFACE micro-os-plus::iii-cortexm
...
message (VERBOSE
         "> micro-os-plus::platform -> platform-nucleo-f767zi-interface"
)
