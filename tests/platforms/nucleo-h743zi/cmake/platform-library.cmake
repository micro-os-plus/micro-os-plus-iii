...
add_library (platform-nucleo-h743zi-interface INTERFACE EXCLUDE_FROM_ALL)

# -----------------------------------------------------------------------------
target_include_directories (
  platform-nucleo-h743zi-interface INTERFACE "include"
)

target_sources (platform-nucleo-h743zi-interface INTERFACE # None
)

target_compile_definitions (
  platform-nucleo-h743zi-interface
...
set (
  ...
  # Embedded builds gnerally must be warning free, but PICO SDK does not allow
  # this. -Werror
...
target_compile_options (
  platform-nucleo-h743zi-interface INTERFACE ${xpack_platform_common_options}
)
...
if ("${CMAKE_C_COMPILER_VERSION}" VERSION_GREATER_EQUAL "12.0.0")
  target_link_options (
    platform-nucleo-h743zi-interface INTERFACE
...
if (COMMAND xpack_display_target_lists)
  xpack_display_target_lists (platform-nucleo-h743zi-interface)
endif ()

# -----------------------------------------------------------------------------
# Aliases.
add_library (micro-os-plus::platform ALIAS platform-nucleo-h743zi-interface)
message (VERBOSE
         "> micro-os-plus::platform -> platform-nucleo-h743zi-interface"
)
